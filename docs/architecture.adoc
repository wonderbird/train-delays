...
For main branch builds, the link:../.github/workflows/build.yml[build pipeline] creates a docker image containing the
build artifact. This image is pushed to https://hub.docker.com[Docker Hub].
