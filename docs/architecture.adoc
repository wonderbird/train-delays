...
the production environment. Save the key to your password manager for using it later.
...
Bahn Open API Key to the Docker container. You can re-create a key on the https://developer.deutschebahn.com/store/site/pages/subscriptions.jag[My Subscriptions Tab].
